...
## Arquivos de Dados (Download Obrigatório)
Para o funcionamento correto, baixe os arquivos Excel abaixo e coloque-os na mesma pasta do script Python:
...
### ⌨️ Coleta de Dados (Inputs e Repetição)
...
### 💾 Saída de Dados (Relatórios e Gráficos)
...
### 🔐 Encapsulamento Avançado (Nested Functions)
